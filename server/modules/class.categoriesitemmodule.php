...
<?php
	/**
	* Categories ItemModule
	*/
	
	class CategoriesItemModule extends ItemModule
	{
		/**
		...
		*/
		function CategoriesItemModule($id, $data)
		{
		...
		{
			$this->properties = $GLOBALS["properties"]->getCategoryProperties($store);
		}
	}
?>
